    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="position-absolute px-2 py-1 text-light rounded" style="background-color: rgba(0, 0, 0, 0.6)"><a href="/posts?category={{ $post->category->slug }}" class="text-light text-decoration-none">{{ $post->category->name }}</a></div>
